      ...
      <div className="row">
        ...
        <div className="col-md-8">
          ...
          <div className="card card-primary">
            ...
            {/* /.card-header */}
            {/* form start */}
            <form onSubmit={onRefuseHandle}>
              <div className="card-body">
              <div className="form-group">
                  <label >Change the status to "Refused" to confirm your choice</label>
                  ...
                  <select class="form-control" name='status' value={data.status} onChange={onChangehandle} >
                          ...
                          <option name='status' value='Refused'>Refused</option>
                        </select>
                </div>
              </div>
              {/* /.card-body */}
